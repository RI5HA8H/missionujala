...
class updateServiceCenter extends StatefulWidget {
  var scId;
  var scLat;
  var scLong;
  var scDistrictId;
  ...
  updateServiceCenter(this.scId,this.scLat,this.scLong,this.scDistrictId,this.scName,this.scContact,this.scEmail,this.scAddress,this.scWebUrl,this.scGeoLocation,);

  @override
  State<updateServiceCenter> createState() => _updateServiceCenterState(scId,scLat,scLong,scDistrictId,scName,scContact,scEmail,scAddress,scWebUrl,scGeoLocation);
}

class _updateServiceCenterState extends State<updateServiceCenter> {
  _updateServiceCenterState(scId,scLat,scLong,scDistrictId,scName,scContact,scEmail,scAddress,scWebUrl,scGeoLocation);
  ...
  getUserToken() async {
    ...
    lat=widget.scLat;
    long=widget.scLong;
    districtDropdownValue=widget.scDistrictId;
    centerNameController.text=widget.scName;
    contactNoController.text=widget.scContact;
    emailController.text=widget.scEmail;
    addressController.text=widget.scAddress;
    wevUrlController.text=widget.scWebUrl;
    mapUrlController.text=widget.scGeoLocation;
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text(allTitle.updateServiceCenterModule,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black),),
                ),
                SizedBox(height: 10,),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 30,),
                        InkWell(
                          child: normalButton(name: 'Update',height:45,bordeRadious: 25,fontSize:14,textColor: Colors.white,bckColor: appcolors.buttonColor,),
                          onTap: (){
  ...
  Future<void> updateServiceCenter() async {
    setState(() {scroll=true;});
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {scroll=false;isUpdate=true;});
      toasts().greenToastLong('Successfully update service center');
    }
    else {
      toasts().redToastLong('Server Error');
      setState(() {scroll=false;});
