...
import 'package:missionujala/Modules/vendorServiceCenterDetailedPage.dart';
      ...
      child: Column(
        children: [
          ListTile(
            ...
            onTap: () async {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => vendorServiceCenterDetailedPage(serviceCenterTypeItem[index])));
            },
          ),
